...
function getChecks(root) {
  ...
  return [
    ...
    },
    {
      ...
      pass: exists(root, '.claude/skills/strategic-compact/SKILL.md'),
      fix: 'Add .claude/skills/strategic-compact/SKILL.md for compaction guidance.',
    },
    {
    ...
    },
    {
      ...
      pass: exists(root, '.claude/rules/common/testing.md') &&
            safeRead(root, '.claude/rules/common/testing.md').includes('80'),
      fix: 'Add .claude/rules/common/testing.md with 80%+ coverage requirement.',
    },
    ...
    },
    {
      ...
      pass: exists(root, '.claude/skills/continuous-learning/SKILL.md'),
      fix: 'Add .claude/skills/continuous-learning/SKILL.md for pattern extraction guidance.',
    },
    ...
    // ── Eval Coverage ────────────────────────────────────────────────────
    {
      ...
      pass: exists(root, '.claude/skills/tdd-workflow/SKILL.md'),
      fix: 'Add .claude/skills/tdd-workflow/SKILL.md.',
    },
    {
      ...
      pass: exists(root, '.claude/skills/verification-loop/SKILL.md'),
      fix: 'Add .claude/skills/verification-loop/SKILL.md.',
    },
    {
      ...
      description: '/learn command exists for pattern extraction',
      pass: exists(root, '.claude/commands/learn.md'),
      fix: 'Add .claude/commands/learn.md to extract reusable patterns from sessions.',
    },
    {
      id: 'eval-roadmap',
      category: 'Eval Coverage',
    ...
    },
    {
      ...
      pass: exists(root, '.claude/rules/common/security.md'),
      fix: 'Add .claude/rules/common/security.md.',
    },
    {
    ...
    },
    {
      ...
      pass: exists(root, '.claude/skills/strategic-compact/SKILL.md'),
      fix: 'Add strategic-compact skill to control context window costs.',
    },
  ];
}
