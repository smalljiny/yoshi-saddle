...
- Working with `*.sql`, `migrations/`, or `schema.*` files
...
- Agent: `database-reviewer` — Full database review workflow (auto-activates on SQL/migrations/schema files)
- Skill: `stack-db-migrations` — Schema migration patterns and zero-downtime deployments
- Skill: `stack-backend` — API and backend patterns
